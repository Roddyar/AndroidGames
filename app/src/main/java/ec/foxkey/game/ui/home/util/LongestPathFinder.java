...
public class LongestPathFinder {
    ...
    public static Integer[] findLongestPath(Graph graph) {
        ...
        start.setColor(HomeFragment.Color.GRAY);
        start.setDistance(0);
        ...
        while (!Q.isEmpty()) {
            ...
            for (int i = 0; i < u.edges.length; i++) {
                ...
                if (u.edges.length > 0) {
                    ...
                    if (transposedGraph.V[u.edges[i]].color == HomeFragment.Color.WHITE) {
                        transposedGraph.V[u.edges[i]].setColor(HomeFragment.Color.GRAY);
            ...
            u.setColor(HomeFragment.Color.BLACK);
        }
